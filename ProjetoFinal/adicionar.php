...
<head>
    ...
    <body>
            ...
            <?php
                include("include/adicionar.inc.php");
            ?>
                ...
                <section class="backgroundsection">
                    ...
                    <div class="adicionarbox">
                        ...
                        <p class="adicionartitle">Adicionar alojamento</p>
                        ...
                        <form name="inserirnew" method="post">
                            <input class="inserirbox" type="text" placeholder="Tipo de alojamento" name="alojamento">
                            ...
                            <input class="inserirbox" type="text" placeholder="Email" name="mail"><br>
                            <input class="descricaobox" type="text" placeholder="Descrição" name="descricao">
                            <input class="escolherbox" type="file" name="foto"><br>
                            <button type="submit" class="criarbtn" name="add">Adicionar <img class="addcriar" src="imagens/add.png" alt="símbolo de adicionar"></button>
                            <button type="submit" class="criarbtnremove" name="remove">Remover <img class="addcriar" src="imagens/remove.png" alt="símbolo de adicionar"></button>
