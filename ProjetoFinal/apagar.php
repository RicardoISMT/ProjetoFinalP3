            ...
            <main>
                ...
                <section class="backgroundsection">
                    ...
                    <div class="iniciarbox">
                        <p class="iniciartitle">Eliminar conta</p>

                        <form name="eliminaracc" method="post">
                            ...
                            <button type="submit" class="criarbtn" name="eliminarconta">Eliminar <img class="arrowcriar" src="imagens/remove.png" alt="seta indicadora para o lado direito"></button>
